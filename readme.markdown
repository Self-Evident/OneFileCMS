...
- Added WYSIWYG-mode: only for webbrowsers that support the designMode; feature is in BETA-stadium. To use it, simply enable $HTML_WYSIWYG_EDIT
- Added german translation file; many strings translated
